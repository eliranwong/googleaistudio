...
class VlcUtil:
    ...
    def isVlcPlayerInstalled():
        ...
        if platform.system() == "Windows":
            if os.path.isfile(windowsVlc):
            ...
            elif HealthCheck.isPackageInstalled("vlc"):
                ...
                VlcUtil.windowsVlc = ""
        if (VlcUtil.macVlc or VlcUtil.windowsVlc or HealthCheck.isPackageInstalled("vlc")):
            return True
        else:
            return False
    ...
    def openVlcPlayer():
        def run(command):
            os.system("{0}{1} > /dev/null 2>&1 &".format("nohup " if HealthCheck.isPackageInstalled("nohup") else "", command))
    ...
    def playMediaFileVlcNoGui(filePath, vlcSpeed=None):
        ...
        elif HealthCheck.isPackageInstalled("cvlc"):
